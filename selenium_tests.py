...
class TestLoginduplicate(unittest.TestCase):
  ...
  def test_signup(self, email = None):
    ...
    WebDriverWait(self.driver, 1000).until(expected_conditions.visibility_of_element_located((By.XPATH, "//div[@id=\'content\']/div/div/div[2]/div/div/div/div/div/div[4]/div/div[3]/div/form/div[2]")))
